...
const { createPercentage, getAllWithdrawals, updateWithdrawalRequest, getAndUpdateWithdrawalRequest, getAllAppointments, getAllDoctors, getAllUser } = require('../../controllers/admin/adminController');
const { isValidUser } = require('../../middlewares.js/auth');
